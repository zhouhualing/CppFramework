...
# test-save-loaded-3-level.tcl script.
...
set Traffic(1) [stc::create "Traffic" \
        -under $Port(1) \
        -rate "100" \
        -rateUnit "Frames Per \"Second\"" \
        -test "&<>\"'\\" ]

# Set up relationships
stc::config $Project(1) -Receives-From-targets " $RFC2544ThroughputTest(1) $Port(1) "
stc::config $Port(1) -Receives-From-targets " $Traffic(1) "
