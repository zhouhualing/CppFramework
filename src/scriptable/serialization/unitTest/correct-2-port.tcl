...
# test-save-loaded-2-port_logic.tcl script. After sourcing the logic script,
...
source [ file normalize [ file join [ file dirname [ info script ] ] {test-save-loaded-2-port_logic.tcl} ] ]
