...
# test-loaded-from-xml_logic.tcl script. After sourcing the logic script,
...
source [ file normalize [ file join [ file dirname [ info script ] ] {test-loaded-from-xml_logic.tcl} ] ]
