...
// Uncomment the following #define to disable Spirent mod.
#define SPIRENT
...
#ifdef SPIRENT
	typedef int Param1Type;
	typedef int Param2Type;
	typedef int Param3Type;
	typedef int Param4Type;
	typedef int Param5Type;
	typedef int Param6Type;
	typedef int Param7Type;
	typedef int Param8Type;
#endif
