...
public:
	...
	{
		SetT<stc::framework::PropId>(0x00053001, val);
	}
	/// \brief Returns the PropertyId
	inline stc::framework::PropId GetPropertyId() const
	{
		return GetT<stc::framework::PropId>(0x00053001);
	}
